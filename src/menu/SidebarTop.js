...
<div className="flex justify-between ">
      ...
      <div className="flex h-14 centered sm:justify-center md:justify-start  mx-auto sm:mx-0   w-full md:w-80 ">
                

                     
                        <a onClick={() => onMenuClick('/')} className="flex cursor-pointer w-full">
                        {mainSidebarOpen ?  <img src="/assets/img/logo.webp" className="ml-2 h-10 animated fadeInDown" alt="logo" /> : ''} 
