...
return (
  <>
    ...
    {/* <table className="border-separate border-spacing-2 border border-slate-600 w-1/3 mx-auto">
  <thead>
    <tr>
  ...
  <tbody>
    <tr>
      <td className="border border-slate-500">Indiana</td>
      <td className="border border-slate-500">Indianapolis</td>
    </tr>
    <tr>
      <td className="border border-slate-500">Ohio</td>
      <td className="border border-slate-500">Columbus</td>
    </tr>
    <tr>
      <td className="border border-slate-500">Michigan</td>
      <td className="border border-slate-500">Detroit</td>
    </tr>
  </tbody>
</table> */}
