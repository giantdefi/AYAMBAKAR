...
export const { setLogout, setUsername, setSponsor, setEmail,  setToken, setIsLogin, setWallet, setBoardNo, setLevel, setIsStokist, setIsAdmin, setIsActive, setEPin, setActiveRefs
