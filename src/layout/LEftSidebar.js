...
<div  class={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform  ${!leftSidebar && "-translate-x-full"} bg-white w-96 mt-24 dark:bg-gray-800`} tabindex="-1" aria-labelledby="drawer-navigation-label">     
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <button onClick={()=>router.push('/logout')} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap ml-4">Logout</span>
            </button>
         </li>
      </ul>
   </div>
