...
export default function TopNavigation() {
    ...
    return (
        <>
            ...
            <div className= {mainSidebarOpen ? "ml-64 fixed w-full flex justify-between h-14 text-white z-10  bg-blue-900 dark:bg-gray-800" :
            "fixed w-full h-14 flex justify-between text-white z-10 bg-blue-900 dark:bg-gray-800"}
            >
                    ...
                    <ul className="flex centered ">
                            <>
                                ...
                                <button className=" flex-initial rounded-full  border-2 border-gray-500  cursor-pointer w-[40px] h-[40px]">
                                    ...
                                    <img src="/assets/img/user-red.webp" className="rounded-full w-[40px]" alt="users" />

                                </button>

                            
                                <button onClick={()=>router.push('/logout')} className="mr-14 flex items-center mr-4 hover:text-blue-100  _btn_submit_red ml-2" 
                                >  Logout</button>
                            </>
